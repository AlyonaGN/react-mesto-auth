            ...
            <Switch>
              <Route exact path={ROUTES_MAP.MAIN}>
                <ul className="header__nav-list">
                  <li className="header__nav-list-item"><span className="header__email">{email ? email : 'kkk'}</span></li>
                  <li className="header__nav-list-item"><button className="header__exit-button">Выйти</button></li>
                </ul>
              </Route>
